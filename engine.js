...
var curFrame = 0; // current sprite animation frame
var frameCount = 4; // number of sprite frames per row

var x = 200; //where to render in canvas
var y = 100;
...
var srcY = 0; //this changes based on keyPressed!

var curMap = 0; //this will change based on the map loaded when switching rooms

var seePickaxe = true; // if true, we can see the pickaxe object
...
function init() {
	...
	var caveAudio = new Audio('CaveWaves.mp3');
	caveAudio.play();
	//YOU NEED TO CREATE A WAY TO PAUSE OR MUTE THE AUDIO IN/WITH THE GAME TOO!
...
function drawMap() {
    ...
    tileAtlas.src='cavetilesmin.png';
...
// MAYBE SET AN AXIS POINT IN THE CENTER OF THE SPRITE THAT CAN COLLIDE WITH THINGS?? THIS MIGHT BE AN EASIER IMPLEMENTATION!
// ADD WALL TILES TO ARRAY SO THAT SPRITE CAN WALK OVER THEM?
...
// CREATE A POINT OR BOX WITHIN THE SPRITE THAT WILL TRIGGER COLLISION CODE??
...
function keydown(e){ 
	...
	console.log(keyPressed); //will show us what is in object.keyPressed 
...
function keyup(e){
	...
	console.log("key up!"); // debugging function problems
